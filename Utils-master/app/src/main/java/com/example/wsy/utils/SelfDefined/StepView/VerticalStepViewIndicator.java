package com.example.wsy.utils.SelfDefined.StepView;
...
public class VerticalStepViewIndicator extends View
{
    ...
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), R.color.powderblue);//定义默认未完成线的颜色  definition mUnCompletedLineColor
