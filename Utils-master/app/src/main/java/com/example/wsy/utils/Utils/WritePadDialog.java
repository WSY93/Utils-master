...
public class WritePadDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p.height = (int) (wm.getDefaultDisplay().getHeight()*0.5);//(int) (d.getHeight() * 0.4);   //高度设置为屏幕的0.4
        p.width = (int) (wm.getDefaultDisplay().getWidth()*1);//(int) (d.getWidth() * 0.6);    //宽度设置为屏幕的0.6
